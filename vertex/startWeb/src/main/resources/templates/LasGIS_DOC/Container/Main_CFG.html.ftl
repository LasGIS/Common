...
<title>Главная конфигурация проекта</title>
</head>

<body>

<h1>Главная конфигурация проекта</h1>
...
общем каталоге проекта. Имя файла может иметь
любое (желательно до 8 знаков и без русских букв,
для связи с DOS). Расширение файла – “<strong>.CFG</strong>”.</p>

<p class="Remark">См. так-же: </p>

<p class="Notice"><a href="Container.html">Внутренний формат файла -
контейнера</a></p>

<h2>1.3. Описание блоков</h2>
