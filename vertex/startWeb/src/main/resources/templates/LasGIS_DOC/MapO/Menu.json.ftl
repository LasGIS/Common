...
var StructMenu = new Array(
  ...
  3, true, "MapO_OPoint.html", "1.2. Точка (OPoint)",
  3, true, "MapO_OLine.html", "1.3. Линия (OLine)",
  3, true, "MapO_OStrip.html", "1.4. Полоса (OStrip)",
  3, true, "MapO_OAreal.html", "1.5. Плоскость (OAreal)",
  3, true, "MapO_OText.html", "1.6. Надпись (OText)</a>",
  3, true, "MapO_eLine.html", "1.7. Элем. линия (eLine)",
  3, true, "MapO_ePoint.html", "1.8. Элем. точка (ePoint)",
