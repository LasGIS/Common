/*
 *  @(#)YandexStatusRestControllerAdvice.java  last: 05.11.2023
 *
...
@Slf4j
@ControllerAdvice(assignableTypes = YandexStatusController.class)
@RequiredArgsConstructor
public class YandexStatusRestControllerAdvice {

    private final YandexStatusRestApiContextHolder contextTool;
    private final YandexStatusRestApiContextConverter converter;

    @ExceptionHandler(PartpriemAdapterDomainEntityNotFoundException.class)
    public Mono<ResponseEntity<YandexErrorStatusRestResponse>> handle(
    ...
    private Mono<ResponseEntity<YandexErrorStatusRestResponse>> toErrorResponse(
        final ServerWebExchange serverWebExchange,
