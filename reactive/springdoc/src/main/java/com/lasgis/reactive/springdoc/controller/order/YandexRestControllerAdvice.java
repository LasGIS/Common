/*
 *  @(#)YandexRestControllerAdvice.java  last: 05.11.2023
 *
...
@Slf4j
@ControllerAdvice(assignableTypes = YandexOrderController.class)
@RequiredArgsConstructor
public class YandexRestControllerAdvice {

    private final YandexRestApiContextHolder contextTool;
    private final YandexRestApiContextConverter converter;

    @ExceptionHandler(PartpriemAdapterDomainEntityNotFoundException.class)
    public Mono<ResponseEntity<YandexErrorRestResponse>> handle(
    ...
    private Mono<ResponseEntity<YandexErrorRestResponse>> toErrorResponse(
        final ServerWebExchange serverWebExchange,
