/*
 * @(#)IReqSessionParameterNames.java
 *
...
package lasgis.react.start.core;

/**
 * The Class IReqSessionParameterNames.
 * @author Vladimir Laskin
 * @version 1.0
 */
public interface IReqSessionParameterNames {
    String APP_USER_PARAM = "appUser";
}
