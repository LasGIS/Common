 ...
 * @author KKiryakov
 */
public class BookingInternationalCreateRequest {
    ...
    @NotNull @Pattern(regexp = "[ERCVU]")
    private final String mailType;
    @NotNull @Pattern(regexp = "[A-Z]")
    private final String letterBeg;
     ...
     * @param letterBeg letter beg
     * @param notificationEmails notification emails
     * @param author author
     * @param comment comment
     */
    @JsonCreator
    public BookingInternationalCreateRequest(
        @JsonProperty("index") String index,
        @JsonProperty("inn") String inn,
        @JsonProperty("companyName") String companyName,
        @JsonProperty("startNumber") Integer startNumber,
        @JsonProperty("count") Integer count,
        @JsonProperty("mailType") String mailType,
        @JsonProperty("letterBeg") String letterBeg,
