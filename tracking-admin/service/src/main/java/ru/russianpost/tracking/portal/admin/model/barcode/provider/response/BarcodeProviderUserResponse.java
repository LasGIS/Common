...
/**
 * Barcode provider user response.
 *
 * @author KKiryakov
 */
public class BarcodeProviderUserResponse extends BarcodeProviderResponse {

    private BarcodeProviderUser user;

    public BarcodeProviderUser getUser() {
        return user;
    }

    public void setUser(BarcodeProviderUser user) {
        this.user = user;
    }
}
