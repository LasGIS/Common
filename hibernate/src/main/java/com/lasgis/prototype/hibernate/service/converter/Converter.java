/*
 *  @(#)Converter.java  last: 07.06.2023
 *
...
public class Converter {
    ...
    public static final Function<UserEntity, User> PERSON_ENTITY_2_PERSON =
        entity -> User.builder()
            .userId(entity.getUserId())
            .login(entity.getLogin())
            .name(entity.getName())
    ...
    public static final Function<User, UserEntity> PERSON_2_PERSON_ENTITY =
        user -> {
            UserEntity entity = new UserEntity();
            entity.setUserId(user.getUserId());
            entity.setLogin(user.getLogin());
